...
class TreatmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create treatment" do
    assert_difference('Treatment.count') do
      post treatments_url, params: { treatment: { cost: @treatment.cost, title: @treatment.title } }
    end
  ...
  test "should update treatment" do
    patch treatment_url(@treatment), params: { treatment: { cost: @treatment.cost, title: @treatment.title } }
